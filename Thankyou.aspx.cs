            ...
            if (u != null && !string.IsNullOrEmpty(orderID))
            {
                ...
                switch (Request.QueryString["ProductID"])
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        lbldes.Text = "เราได้รับการยืนยันการโอนเงินจากคุณเรียบร้อยแล้ว <strong>กรุณารอการยืนยันจากทีมงานประมาณ 1-3 วัน </strong> ทางทีมงานจะส่งอีเมลและโทรติดต่อคุณทันทีที่การโอนเงินได้รับการยืนยันจากเจ้าหน้าที่ จากนั้นทีมผู้เชี่ยวชาญระทำการนัดหมายคุณเพื่อรับการโค้ชในวัน-เวลาที่คุณสะดวก";
                        break;
                }
