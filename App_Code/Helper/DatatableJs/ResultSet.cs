...
namespace MVCDatatableApp
{
    ...
    {
        //public List<object> GetResult(string search, string sortOrder, int start, int length, List<object> dtResult, List<string> columnFilters)
        //{
        //    return FilterResult(search, dtResult, columnFilters).SortBy(sortOrder).Skip(start).Take(length).ToList();
        //}

        //public int Count(string search, List<object> dtResult, List<string> columnFilters)
        //{
        //    return FilterResult(search, dtResult, columnFilters).Count();
        //}

        //private IQueryable<object> FilterResult(string search, List<object> dtResult, List<string> columnFilters)
        //{
        //    IQueryable<object> results = dtResult.AsQueryable();
