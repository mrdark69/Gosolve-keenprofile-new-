<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="UsersContent.aspx.cs" Inherits="_UserContent" %>
                    ...
                    <div class="tabs-container">
                        ...
                        <div class="tab-content">
                            <div id="tab_content1" runat="server" class="tab-pane active">
                                ...
                                <h4 id="headsection_pan" runat="server">Create a new Functional Competencies</h4>
                                <hr />
                             <%--   <asp:ValidationSummary runat="server" CssClass="text-danger" />--%>
                                <asp:Label ID="lblsms" runat="server"></asp:Label>

                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="SectionTitle" CssClass="col-md-2 control-label">Functional Competencies</asp:Label>
                                    <div class="col-md-10">
                        ...
                        <div class="ibox-title" style="border:none;">
                            <h5>Functional Competencies List </h5>
...
<asp:Content ID="FooterScript" ContentPlaceHolderID="ContentFooter" runat="server">
    <script type="text/javascript">
        ...
        function getList(v) {
            ...
            var url = "<%= ResolveUrl("/admin/Content/ajax_webmethod_assessment.aspx/GetFCAll") %>";
        ...
        function getSectionList(v) {
            ...
            var url = "<%= ResolveUrl("/admin/Content/ajax_webmethod_assessment.aspx/GetCJFAll") %>";
        ...
        function GenSectionlistAll(data) {
            ...
            for (var i in data) {
                ...
                ret += '   <td style="text-align:center"><a href="UsersContent?tab=2&cjf=' + data[i].CJFID + '"><i class="fa fa-pencil"></i> Edit </a></td>';
                ret += '   </tr >';
            }
        ...
        function GenlistAll(data) {
            ...
            for (var i in data) {
                ...
                if (!data[i].Status) { txt = 'Inactive'; bage = 'default'; }
                ret += '   <td style="text-align:center"><span class="label label-' + bage+'">' + txt + '</span></td>';
                ret += '   <td style="text-align:center"><a href="UsersContent?fc=' + data[i].FCID + '"><i class="fa fa-pencil"></i> Edit </a></td>';
                ret += '   </tr >';
            }
