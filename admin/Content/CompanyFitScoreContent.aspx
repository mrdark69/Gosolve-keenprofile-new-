<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CompanyFitScoreContent.aspx.cs" Inherits="_JobFitScoreContent" %>
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li class="active" id="li_tab1" runat="server"><a href="JobFitScoreContent" id="tab1" runat="server" aria-expanded="true">Company Fit Score Explanation</a></li>
