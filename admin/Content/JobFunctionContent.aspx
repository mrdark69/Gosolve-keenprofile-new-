<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="JobFunctionContent.aspx.cs" Inherits="_JobFunctionContent" %>
                            ...
                            <div id="tab_content1" runat="server" class="tab-pane active">
                             ...
                             <%--   <asp:ValidationSummary runat="server" CssClass="text-danger" />--%>
                                <asp:Label ID="lblsms" runat="server"></asp:Label>
                                    ...
                                    <asp:Label runat="server" AssociatedControlID="groupid" CssClass="col-md-2 control-label">Group ID</asp:Label>
                                    <div class="col-md-10">
                                        <asp:TextBox runat="server" ID="groupid" CssClass="form-control" />
                                        <asp:RequiredFieldValidator runat="server" ControlToValidate="groupid"
...
<asp:Content ID="FooterScript" ContentPlaceHolderID="ContentFooter" runat="server">
    <script type="text/javascript">
        ...
        function getList(v) {
            ...
            var url = "<%= ResolveUrl("/admin/Content/ajax_webmethod_assessment.aspx/JobFucntionGroup") %>";
        ...
        function GenlistAll(data) {
            ...
            for (var i in data) {
                ...
                ret += '   <td>' + data[i].JGID + '</td>';
                ret += '   <td><a href="JobFunctionContent?g=' + data[i].JGID + '">' + data[i].Title + '</a></td>';
                ...
                ret += '   <td style="text-align:center"><a href="JobFunctionContent?g=' + data[i].JGID + '"><i class="fa fa-pencil"></i> Edit </a></td>';
                ret += '   </tr >';
            }
