<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="Users_Products" %>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <%--<th></th>--%>
                                                  <th> <a href="#" class="th_sort" data-sort="asc"  data-column="ProductID">ProductID <i class="fa fa-sort"></i></a></th>
                                                    <th><a href="#" class="th_sort" data-sort="desc"  data-column="Title">Title <i class="fa fa-sort"></i></a></th>
                                              
                                                <th> <a href="#" class="th_sort" data-sort="asc"  data-column="Price"> Price <i class="fa fa-sort"></i></a></th>
...
<asp:Content ID="FooterScript" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getList() {
            ...
            var url = "<%= ResolveUrl("/admin/Product/ajax_webmethod_product.aspx/GetProductAll") %>";
        ...
        function GenlistAll(data) {
            ...
            for (var i in data) {
                ...
                var myNumeral = numeral(data[i].Price);
                var strPrice = myNumeral.format('0,0.00');
                ret += '<tr>';
                ret += '   <td>KP' + data[i].ProductID + '</td>';
