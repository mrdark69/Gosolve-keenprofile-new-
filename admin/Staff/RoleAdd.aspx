<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="RoleAdd.aspx.cs" Inherits="Staff_RoleAdd" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <%-- <asp:Panel runat="server" ID="resetPassword" Visible="false">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
               ...
               <asp:Button runat="server" ID="Button1"  OnClick="btnSave_Click" Text="Save" CssClass="btn btn-w-m btn-primary" />
            </div>
        </div>
    </div>
                     </div>
    ...
    <div class="hr-line-dashed"></div>
            ...
            <div class="col-md-offset-2 col-md-10">
                ...
                <%--<asp:Button runat="server" ID="btnSaveAction"  OnClick="btnSaveAction_Click" Text="Disable Role" CssClass="btn btn-w-m btn-primary" />--%>
            </div>
        </div>
